...
def plot_dataframe(
        df: pd.DataFrame,
        xvar: str = None,
        yvar: Optional[Union[str, Iterable[str]]] = None,
        yvar_labels: Union[Iterable[str], Mapping[str, str]] = None,
        moment: Optional[str] = None,
        by: Optional[str] = None,
        by_labels: Optional[Union[Iterable[str], Mapping, Callable]] = None,
        ...
        plot_type: Optional[Union[str, Mapping[str, str], Iterable[str]]] = None,
